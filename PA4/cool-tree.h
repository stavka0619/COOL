...
class ClassTable; // forward declaration
typedef SymbolTable<Symbol, Class__class> SymTable;
...
public:
   ...
   virtual void build_env(ClassTable *classtable, SymTable *symtable) = 0;
   virtual void semant(ClassTable *classtable, SymTable *symtable) = 0;
#ifdef Class__EXTRAS
   Class__EXTRAS
#endif
};
...
public:
   ...
   virtual void build_env(ClassTable *classtable, SymTable *symtable) = 0;
   virtual void semant(ClassTable *classtable, SymTable *symtable, Symbol selftype) = 0;
...
public:
   ...
   virtual Symbol check_type(ClassTable *classtable, SymTable *symtable, Symbol selftype) = 0;
...
public:
   ...
   void build_env(ClassTable *classtable, SymTable *symtable);
   void semant(ClassTable *classtable, SymTable *symtable);
...
public:
   ...
   void build_env(ClassTable *classtable, SymTable *symtable);
   void semant(ClassTable *classtable, SymTable *symtable, Symbol selftype);
...
public:
   ...
   Symbol check_type(ClassTable *classtable, SymTable *symtable, Symbol selftype);
